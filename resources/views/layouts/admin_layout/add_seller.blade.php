                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                            <form action="{{ url('save-seller') }}" id="userform" name="userform" method="POST" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                                        ...
                                        <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="mb-3 input-cpassword">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="seller_name" name="seller_name" type="text" class="form-control" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="full_address">Address</label>
                                                            <input type="text" name="full_address" id="full_address" value="" class="form-control">
