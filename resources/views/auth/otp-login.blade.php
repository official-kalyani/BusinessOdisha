                ...
                success: function(response) {
                    if (response.registered == 'registered') {
                        ...
                        if (response.user_type == 'seller') {
                            $('#err-msg').html(
                            'Mobile number is not registered.Please <a href="{{ url("/seller-register")}}">register</a>.'
                            );
                        }else{
                            $('#err-msg').html(
                            'Mobile number is not registered.Please <a href="{{ url("/customer-register")}}">register</a>.'
                            );
                        }
