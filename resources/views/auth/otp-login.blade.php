        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-8 px-0 d-none d-sm-block">
                    <img src="{{ asset('frontend/img/beautiful-young-family-with-child-compress.png') }}" alt="Login image" class="w-100 vh-100" style="object-fit: cover; object-position: center;">
                </div>
            </div>
        </div>
    </section>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.registered == 'registered') {
                            ...
                            $('#err-msg').html('Mobile number is not registered.Please <a href="{{ url("/customer-register")}}">register</a>.');
